...
const TwoColSliderSection = dynamic(() =>  import( './InnerPagesSection/TwoColSliderSection'))
const CoreValueTabSection= dynamic(() =>  import( './InnerPagesSection/CoreValueTabSection'))
const TeamThoughtSection= dynamic(() =>  import( './InnerPagesSection/TeamThoughtSection'))
const AboutJoinTeamSection = dynamic(() =>  import( './AboutpageSection/AboutJoinTeamSection'))
const Meta = dynamic(() =>  import( './Meta'))

export default class LifeAtWaaree extends Component {
    ...
    render(){
       ...
       meta={this.data()}/>
        ...
        <TwoColSliderSection data={this.props.Life_At_Waaree} />
        <CoreValueTabSection data={this.props.About_Core_Value} />
        <TeamThoughtSection data={this.props.Life_At_Waaree} />   
