...
const  JobOpportunitySection = dynamic(() =>  import( '../Components/InnerPagesSection/JobOpportunitySection'))
const  ExploreLifeWaaree = dynamic(() =>  import( '../Components/InnerPagesSection/ExploreLifeWaaree'))
...
export default class Careers extends Component{
    ...
    render(){
        ...
        <JobOpportunitySection data={this.props.Career_Data} />
        <ExploreLifeWaaree data={this.props.Career_Data} />    
