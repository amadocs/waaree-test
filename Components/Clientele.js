...
const ClienteleLogoSection = dynamic(() =>  import('./InnerPagesSection/ClienteleLogoSection'))

export default class Clientele extends Component{
    constructor(props) {
        super(props)      
    };
    ...
    render(){
        ...
        <ClienteleLogoSection  data={this.props.Clientele_Logo_Section} />
