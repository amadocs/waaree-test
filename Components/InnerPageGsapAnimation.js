        ...
        setTimeout(function() {
            ...
            if (noFullpagePage.length) {
                ...
                [].forEach.call(Section, function(item) {
                    ...
                    var paragraph = item.querySelectorAll('.team-member-title > span ,.company-logo-section .title-small, .contact-footer-row h4, .banner-text, .content-text-wrap, .content-text, .subtitle-wrap, .team-content-text, .case-study-text');
