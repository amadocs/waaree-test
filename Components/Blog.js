...
const BlogMainSection = dynamic(() =>  import( './InnerPagesSection/BlogMainSection'))
...
export default class Partner extends Component{
    ...
    render(){
        ...
        <BlogMainSection data={this.props.Blog} Blog_Category={this.props.Blog_Category} Blog_Display={this.props.Blog_Display} blog_count={this.props.blog_count} />
