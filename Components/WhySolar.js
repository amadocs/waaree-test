...
const WhySolarContentSection  = dynamic(() =>  import('./InnerPagesSection/WhySolarContentSection'))
const SolarEnergySection  = dynamic(() =>  import( './InnerPagesSection/SolarEnergySection'))
const UseSolarSection  = dynamic(() =>  import('./InnerPagesSection/UseSolarSection'))
const SolarEnergyCounterSection  = dynamic(() =>  import( './InnerPagesSection/SolarEnergyCounterSection'))
...
export default class WhySolar extends Component{
    ...
    render(){
        ...
        <WhySolarContentSection data={this.props.Why_Solar} Why_Solar_Benifits_Row={this.props.Why_Solar_Benifits_Row} /> 
        <SolarEnergySection data={this.props.Why_Solar} />
        <UseSolarSection data={this.props.Why_Solar} />
        <SolarEnergyCounterSection  data={this.props.Why_Solar} />
