...
const ContactLocationSection = dynamic(() =>  import( './ContactpageSection/ContactLocationSection'))
const ContactHelpSection = dynamic(() =>  import( './ContactpageSection/ContactHelpSection'))
const ContactFormSection = dynamic(() =>  import( './ContactpageSection/ContactFormSection'))
const ContactFooterSection = dynamic(() =>  import( './ContactpageSection/ContactFooterSection'))
...
export default class Contact extends Component {
    ...
    render(){
        ...
        <ContactFormSection  />
        <ContactLocationSection Data={this.props.Contact_Location} />
        <ContactHelpSection Contact_Help={this.props.Contact_Help} />
        <ContactFooterSection Data={this.props.Contact_Footer_Section} />
