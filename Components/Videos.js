...
const PartnerVideoFullWidthSection = dynamic(() =>  import( './InnerPagesSection/PartnerVideoFullWidthSection'))
const VideoGallarySection = dynamic(() =>  import('./InnerPagesSection/VideoGallarySection'))
const VideoGallaryFourCol = dynamic(() =>  import('./InnerPagesSection/VideoGallaryFourCol'))
...
export default class Videos extends Component{
    ...
    render(){
        ...
        <PartnerVideoFullWidthSection Data={this.props.Video_Section} /> 

        <VideoGallarySection gallaryType={<VideoGallaryFourCol data={this.props.Video_Section} />}/>
