...
const SitemapSection = dynamic(() =>  import( './InnerPagesSection/SitemapSection'))
...
export default class Sitemap extends Component{
    ...
    render(){
        ...
        <InnerBannerSection 
             bgSrc={this.props.path?.Banner_Image ? 
                this.props.path?.Banner_Image?.data[0]?.attributes?.url  : 
                process.env.NEXT_PUBLIC_NO_IMAGE}
             pageTitle={this.props?.path?.Page_Title}
             bannerText={this.props?.path?.Short_Description} />
        <SitemapSection MoreMenu={this.props.MoreMenu} />
