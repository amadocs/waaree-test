...
const CurrentOpeningSection  = dynamic(() =>  import( './InnerPagesSection/CurrentOpeningSection'))
const OurCultureContentSection  = dynamic(() =>  import( './InnerPagesSection/OurCultureContentSection'))
const EmployeeAssociateSection  = dynamic(() =>  import( './InnerPagesSection/EmployeeAssociateSection'))
const Meta  = dynamic(() =>  import( './Meta'))

export default class OurCulture extends Component {
    ...
    render(){
       ...
       meta={this.data()}/>
        ...
        <InnerBannerSection bgSrc={this.props.path?.Banner_Image ? this.props.path?.Banner_Image?.data[0]?.attributes?.url  : process.env.NEXT_PUBLIC_NO_IMAGE} pageTitle={this.props?.path?.Page_Title} bannerText={this.props?.path?.Short_Description} /> 
         <OurCultureContentSection data={this.props.Culture_Data} />
        <CurrentOpeningSection data={this.props.Culture_Data} />
        <EmployeeAssociateSection data={this.props.Culture_Data} />
