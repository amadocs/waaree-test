...
export default function EventImageGallery(props) {
    ...
    useEffect(async () => {
            setTimeout(() => {
                ...
                btnId.onclick = function () {
                    ...
                    setVisibleBlogs(props.data?.attributes?.Event_Gallery.length)
            ...
            <div className="image-gallary-row">
                {
                    ...
                    <div id="lightgallery" className="lightgallary-wrap">
                        ...
                        {props.data?.attributes?.Event_Gallery.slice(0, visibleBlogs).map((val) =>
                            <div className="gallary-item "
                                ...
                                <a href={val?.Gallery_Image?.data?.attributes?.url
                                    ? val?.Gallery_Image?.data?.attributes?.url
                                    : process.env.NEXT_PUBLIC_NO_IMAGE}>
                                    <img priority="false" alt="Gallery Image Icon" src={val?.Gallery_Image?.data?.attributes?.url
                                        ? val?.Gallery_Image?.data?.attributes?.url
