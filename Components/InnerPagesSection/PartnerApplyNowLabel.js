...
export default class PartnerApplyNowLabel extends Component  {
                ...
                <div className="apply-now-banner" style={{ backgroundImage: `url(${this.props.data?.attributes?.Apply_Now_Background_Image?.data?.attributes?.url
                    ...
                    <div className="apply-banner-wrap">
                        <div className="icon-wrap">
                            <img priority="false" src={this.props.data?.attributes?.Apply_Now_Icon?.data?.attributes?.url
                                    ? this.props.data?.attributes?.Apply_Now_Icon?.data?.attributes?.url
