...
const  DownloadAccordionSection = dynamic(() =>  import( './InnerPagesSection/DownloadAccordianSection'))
const  InnerPageGsapAnimation = dynamic(() =>  import('./InnerPageGsapAnimation'))
const  Meta = dynamic(() =>  import('./Meta'))

export default class Downloadcenter extends Component{
    ...
    render(){
        return(
            ...
            <DownloadAccordionSection  Download_Center={this.props.Download_Center} />
